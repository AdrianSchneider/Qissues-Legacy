...
use Qissues\Domain\Tracker\Metadata\Builder;
...
class BuilderTest extends \PHPUnit_Framework_TestCase
{
    public function testBuild()
    {
        ...
        $storage = $this->getMock('Qissues\Domain\Tracker\Metadata\Storage');
        $storage
            ->expects($this->once())
            ->method('exists')
            ->with($key)
    ...
    public function testReturnNullMetadataWhenUnavailable()
    {
        ...
        $this->assertInstanceOf('Qissues\Domain\Tracker\Metadata\NullMetadata', $metadata);
    }
}
