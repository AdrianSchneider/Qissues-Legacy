...
use Qissues\Model\Tracker\Metadata\Builder;
...
class BuilderTest extends \PHPUnit_Framework_TestCase
{
    public function testBuild()
    {
        ...
        $storage = $this->getMock('Qissues\Model\Tracker\Metadata\Storage');
        $storage
            ->expects($this->once())
            ->method('exists')
            ->with($key)
    ...
    public function testReturnNullMetadataWhenUnavailable()
    {
        ...
        $this->assertInstanceOf('Qissues\Model\Tracker\Metadata\NullMetadata', $metadata);
    }
}
